...
Route::get('/media/{slug}', [App\Http\Controllers\FrontendController::class, 'view'])->name('frontend.view');
...
Route::get('/songspages', [App\Http\Controllers\FrontendController::class, 'songspage'])->name('frontend.songspages');

Route::get('/team', [App\Http\Controllers\FrontendController::class, 'team'])->name('frontend.team');
Route::get('/full_cast_crew/{slug}', [App\Http\Controllers\FrontendController::class, 'castandcrew'])->name('frontend.full_cast_crew');
Route::get('/song/{slug}', [App\Http\Controllers\FrontendController::class, 'songDetailPage'])->name('frontend.song');

Route::get('/profile/{slug}', [App\Http\Controllers\FrontendController::class, 'profiles'])->name('frontend.profiles');
...
Route::group(['prefix' => 'admin'], function () {
    ...
    Route::get('/media-image/add', [App\Http\Controllers\MediaImageController::class, 'add'])->name('mediaimage.create')->middleware('auth');
