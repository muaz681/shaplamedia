    ...
    <div class="footer_top_area">
        <div class="copy_right_text">
            <div class="logo">
                ...
                {{-- <img class="logos foot" src="{{asset('img/shapla/logo.png')}}"; alt="shapla media"> --}}
            </div>
            <p class="pt-2 pb-2">©Shapla Media 2021 All Rights Reserved</p>
        </div>
        <div class="footer_top_right">
            ...
            <div class="social_links">
                <a href="https://www.facebook.com/shaplamediafilm/">
                    <i class="ti-facebook"></i>
                </a>
                <a href="https://youtube.com/c/ShaplaMedia">
