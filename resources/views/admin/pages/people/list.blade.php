      ...
      <section class="content">
        ...
        {{ Form::open(['method' => 'GET', 'enctype' => 'multipart/form-data']) }}
          <div class="card-header">
            <div class="row px-2">
              ...
              <div class="w-auto mx-2">
                <a href="{{ route('people.add') }}" class="btn btn-outline-primary">+ Add Profile</a>
              </div>
              <div class="w-auto mx-2">
                <a href="{{ route('people.index') }}" class="btn btn-outline-secondary btn-sm mt-1"><i class="fa fa-undo"></i>Clear</a>
              </div>
              <div class="w-auto ml-auto">
                <h3 class="card-title">Showing {{$people->firstItem()}}-{{$people->lastItem()}} of {{$people->total()}} items.</h3>
              </div>
            </div>
          </div>
          <div class="card-body"> 
          ...
          <div class="card-footer clearfix">
              {!! $people->withQueryString()->links('pagination::bootstrap-4') !!}
          </div>
        </div> 
      </section>
      <!-- /.card-body -->
