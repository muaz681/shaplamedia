  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        {{ Form::open(['method' => 'POST', 'route' => 'people.store', 'enctype' => 'multipart/form-data']) }}
        <div class="row">
          <!-- left column -->
          <div class="col-md-9">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    {{-- <div class="form-group"> --}}
                      ...
                      {{ Form::select('gender', getGender(), $fdata->gender,['class' =>  'form-control myselect2', 'placeholder' => 'Select Media Type']) }}
                    {{-- </div> --}}
                  </div>
                  <div class="form-group">
