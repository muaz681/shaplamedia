<aside class="main-sidebar sidebar-dark-primary elevation-4">
    <!-- Brand Logo -->
    <div class="row" style="border-bottom:2px solid #c1c1c1;">
      <div class="col-4">
        <a href="#" style="margin-left:-32px;">
          <img src="{{asset('assets/admin/dist/img/profile.jpg')}}"
               alt="shapla media"
               class="brand-image img-circle elevation-3 ml-5"
               style="opacity: .9; width: auto; height: 52px; margin-top: 18px;margin-bottom: 5px;">
        </a>
      </div>
      <div class="col-8" style="margin-top:18px;">
        <span style="color:white;" class="brand-text font-weight-light">{{Auth::user()->name}}</span>
      </div>
    </div>
    {{-- <a href="#" class="brand-link">
      <img src="{{asset('assets/admin/dist/img/profile.jpg')}}"
           ...
           class="brand-image img-circle elevation-3 ml-5"
           style="opacity: .9"><br> --}}
      {{-- <span style="margin-left:5px;" class="brand-text font-weight-light">Shapla Media</span> --}}
      {{-- <span style="" class="brand-text font-weight-light">{{Auth::user()->name}}</span> --}}
    {{-- </a> --}}
    <!-- Sidebar -->
    <div class="sidebar">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="{{route('mediaimage.create')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
